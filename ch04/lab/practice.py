...
# square1 = [dimensions[0]//4, dimensions[1]//2]
# square2 = [(3*dimensions[0])//4, dimensions[1]//2]

pygame.draw.rect(screen,"blue", pygame.Rect(30, 100, 500, 500) )
pygame.draw.rect(screen,"yellow", pygame.Rect(540, 100, 500 , 500))

pygame.display.flip()
pygame.time.wait(2000)


# Make next part about point colliding with a rectangle above and use that to make bet
user_guess = []
